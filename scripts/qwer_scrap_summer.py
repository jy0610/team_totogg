...
from totogg.models import Summer_Data
from webdriver_manager.chrome import ChromeDriverManager
import time

Url = 'https://qwer.gg/ko/leagues/LCK/2022/Summer?tournament=%22949%22'
# url -> '결과' 선택
# 2022 Spring 선택
...
def scrapBlue(driver, match_num, set):
  ...
  #DB에 입력
  Summer_Data(match_num=match_num, team=team, rst=rst, side=side, gtime=gtime,
